...
<html>
	<head>
		...
		<script type="text/javascript" src="<%=basePath%>js/user/htbackstage.js"></script>
					...
					<table>
						...
						<tr>
							...
							<td class="in">
								...
								<button value="<s:property value="#NACACDTOL.userInfo.user_id"
							...
							escape="false" />"><font
											...
											<button class="btn2" id="<s:property value="#NACACDTOL.userInfo.user_id"
													escape="false" />""
...
<!--社团管理模态框-->
				<div class="modal_comm" id="modal_comm">
					<ul>
						<li>
							<label class="lab">发布</label>
							<div class="Inpstyle2">
								<input class="Inpstyle" type="file"/>
							</div>							
						</li>
						<li>
						...
						<li>
							<label class="lab">社团名称</label>
							<div class="Inpstyle2">
								<input class="Inpstyle" type="text" />
							</div>
						</li>
						<li>
						...
						<li>
							<label class="lab">社团logo</label>
							<div class="Inpstyle2">
								<input class="Inpstyle" type="file" />
							</div>
						</li>
						<li>
							<label class="lab">阅读人数</label>
							<div class="Inpstyle2">
								<input class="Inpstyle" type="text" />
							</div>
						</li>
						<li>
							<label class="lab">喜欢人数</label>
							<div class="Inpstyle2">
								<input class="Inpstyle" type="text" />
							</div>
						</li>
						<li>
							<label class="lab">社团人数</label>
							<div class="Inpstyle2">
								<input class="Inpstyle" type="text" />
							</div>
						</li>
						...
						<li class="checkBtn">
							<button onclick="hide2()" id="checkBtn1" type="button">确认修改</button>
							<button onclick="hide2()" id="checkBtn2" type="button" >取消</button>
						</li>
					</ul>
				</div>
