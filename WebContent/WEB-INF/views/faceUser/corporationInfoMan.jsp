				...
				<div class="user-info">
					<form>
						<ul class="user-info-text">
							...
							<li><label>立社时间</label><input readonly="true" id="corporation_apply_time" class="calender" type="text" id="datetimeStart2" value="<s:property value="corporationInfo.corporation_apply_time"/>"/></li>
